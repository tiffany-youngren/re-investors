...
async function fetchUserProfile(userId) {
  try {
    const { data, error } = await supabase
      .from('profiles')
      .select('id, user_id, first_name, last_name, email, phone, phone_country_code, role, approved, license_status, brokerage_name, city, state, investment_areas, avatar_url')
      .eq('user_id', userId)
      .single()
